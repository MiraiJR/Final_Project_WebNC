...
export default function AcceptInvitingDialog() {
  ...
  if (JwtStorage.getToken()?.accessToken == "") {
    navigate(
      "/auth/sign-in?next=" + window.location.pathname + "?token=" + token
    );
  }
  if (token == null) {
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            "Click 'Join' to accept the class invitation. Please ensure that the
            email associated with your account matches the email address to
