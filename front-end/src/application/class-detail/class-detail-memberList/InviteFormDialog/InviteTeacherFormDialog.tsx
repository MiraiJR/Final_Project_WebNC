...
interface InviteTeacherFormDialogProps{
    open: boolean,
    onClose : ()=>void,
...
export default function InviteTeacherFormDialog({open,onClose,teacherEmailList}:InviteTeacherFormDialogProps){
    ...
    const addEmailToList =  (data: Inputs)=> {
        ...
        if(!emailList.includes(newEmail)&&!teacherEmailList.includes(newEmail)){
    ...
    return(
        <Dialog open={open} onClose={onClose}>
            <DialogTitle>Invite to class as Teacher</DialogTitle>
